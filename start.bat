...
echo.
echo  ============================================================
echo   MAYNIAK AI STUDIO  ^|  %SETUP_MODE%
echo  ============================================================
echo.
if "%SETUP_MODE%"=="First-Time Setup" (
    echo  This looks like your first run. Setting up automatically...
) else (
    echo  Mayniak AI Studio needs a quick repair before launch.
)
...
echo.
echo  ============================================================
echo   MAYNIAK AI STUDIO  ^|  Launching...
echo  ============================================================
echo.
...
echo  Starting Mayniak AI Studio...
